...
function GlobalStats() {
  ...
  return (
    <div>
      ...
      <p>You have signed up for Diary for {globalStats.registrationSince} days.</p>
      ...
      <p>
        In your historical longest streak, you recorded entries for {globalStats.historicalLongestStreakByEntry} days.
      </p>
